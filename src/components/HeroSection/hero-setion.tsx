export function HeroSection() {
    return (
      <section className="xl:mt-32 xl:mb-96 xl:mx-32 max-sm:m-8">
        ...
        <img className="absolute xl:right-56 max-sm:right-24 h-3/5 object-contain top-0 -z-10" src="src\assets\bg.svg"/>
        <img className="absolute right-0 h-3/5 object-contain bottom-20 -z-10" src="src\assets\hero-content.png"/>
      </section>
    );
}
